...
jest.mock('@/theme/colors', () => ({
  colors: {
    pitchGreen: '#2EFC5D', grassShadow: '#1A9E38', stadiumNavy: '#05050A',
    floodlightWhite: '#FFFFFF', cardYellow: '#FACC15', redCard: '#EF4444',
    warningOrange: '#FF4D00', warningOrangeShadow: '#CC3D00',
    amber: '#F59E0B', amberShadow: '#D97706',
    surface: '#0E121A', textSecondary: '#A0ABC0',
    glassBackground: 'rgba(255, 255, 255, 0.03)',
    glassBorder: 'rgba(255, 255, 255, 0.08)',
    goldPrimary: '#FFD700', goldShadow: '#B8960F',
    accentBlue: '#00E5FF', neonGreenGlow: 'rgba(46, 252, 93, 0.3)',
    dangerRed: '#FF3366',
    primary: '#2EFC5D', primaryShadow: '#1A9E38', background: '#05050A',
    text: '#FFFFFF', warning: '#FACC15', error: '#EF4444', success: '#2EFC5D',
  },
  depthColors: {
    pitchGreen: '#1A9E38', stadiumNavy: '#020205', redCard: '#B91C1C',
