...
export function ArticleCard({ article }: ArticleCardProps) {
  ...
  return (
    <Link href={`/blog/${article.slug}`} className="group block">
      <article className="bg-white/5 backdrop-blur-[10px] border border-white/10 rounded-xl overflow-hidden transition-all duration-200 group-hover:border-pitch-green/30 group-hover:bg-white/[0.07]">
