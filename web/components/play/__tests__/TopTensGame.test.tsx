...
const fakeContent: TopTensContent = {
  ...
  answers: [
    ...
    { name: "Andy Cole", aliases: [], info: "187 goals", alternates: [] },
    { name: "Sergio Agüero", aliases: ["Aguero"], info: "184 goals", alternates: [] },
    { name: "Frank Lampard", aliases: [], info: "177 goals", alternates: [] },
    { name: "Thierry Henry", aliases: ["Henry"], info: "175 goals", alternates: [] },
    { name: "Mohamed Salah", aliases: ["Salah"], info: "169 goals", alternates: [] },
    { name: "Robbie Fowler", aliases: [], info: "163 goals", alternates: [] },
    { name: "Jermain Defoe", aliases: ["Defoe"], info: "162 goals", alternates: [] },
  ],
};
