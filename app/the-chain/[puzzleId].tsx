...
/**
 * Dynamic route for The Chain game with specific puzzle ID.
 ...
 */
export default function TheChainRoute() {
  ...
  if (!puzzleId) {
    return <Redirect href="/the-chain" />;
  }

  return (
    <>
      <Stack.Screen options={{ headerShown: false }} />
      <PremiumGate puzzleId={puzzleId} puzzleDate={puzzleDate} gameMode="the_chain">
        <TheChainScreen puzzleId={puzzleId} />
      </PremiumGate>
    </>
  );
}
